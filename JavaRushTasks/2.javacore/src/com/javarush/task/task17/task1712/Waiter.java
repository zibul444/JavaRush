...
public class Waiter implements Runnable {
    ...
    public void run() {
        ...
        while (continueWorking || !manager.getDishesQueue().isEmpty()) { // если официант работает или есть блюда
//            System.out.println("!manager.getDishesQueue().isEmpty()" + !manager.getDishesQueue().isEmpty() + "__________________");

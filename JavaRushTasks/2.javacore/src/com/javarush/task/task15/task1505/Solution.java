...
Метод containsBones должен возвращать тип Object и значение «Yes» вместо true, «No» вместо false
*/
...
public class Solution {
    ...
    public static class Finger extends BodyPart {
        ...
        public Finger(String name, boolean isArtificial) {
            ...
            if (isArtificial == false) containsBones = "No";
        }

        public Object containsBones() {
            String bounes = "No";

            if (!isArtificial) bounes = "Yes";
